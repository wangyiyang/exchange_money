...
class APIPrivateCall(APICall):
    ...
    def _get_nonce(self):
        return str(int(time.time() * 9999999999))
...
class APIUserOrderStatus(APIPrivateCall):
    url = 'order_status/'